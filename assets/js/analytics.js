   ...
   */
    ...
    var bd = function (a) {
        ...
        Ge = function (a) {
            switch (a) {
                default:
                case 1:
                    return "https://"+location.host+"/analytics/gtm/js?id=";
                case 2:
            ...
            if (!a.get(Qe) && (a.set(Qe, !0), !a.get("&gtm"))) {
                ...
                if (b) {
                    O["google.tagmanager.debugui2.queue"] ||
                        ((O["google.tagmanager.debugui2.queue"] = []),
                            Id("https://"+location.host+"/analytics/debug/bootstrap"));
    ...
    var u = function (a, b, c) {
        ...
        B = function (a) {
            ...
            return ""+location.host+"/analytics" == a.host &&
                (a.port || b) == b &&
                D(a.path, "/plugins/")
                ? !0
                : !1;
